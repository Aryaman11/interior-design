function Footer () {
    return (
        <div className="my-4 ml-44 mr-32">
            <div className="flex">
             <div className="w-1/3 mr-12">
                <div className="flex items-center font-serif text-3xl justify-items-center font-medium">
                    <svg  className='mr-1' xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
                    <path d="M10.4167 41.6665V22.6165L6.38542 25.7207L5.12917 24.0707L25 8.854L44.8708 24.0707L43.6146 25.7082L39.5833 22.6165V41.6665H10.4167ZM16.6667 30.7707C16.2361 30.7707 15.8611 30.6109 15.5417 30.2915C15.2222 29.9721 15.0625 29.5971 15.0625 29.1665C15.0625 28.7359 15.2222 28.3609 15.5417 28.0415C15.8611 27.7221 16.2361 27.5623 16.6667 27.5623C17.0972 27.5623 17.4722 27.7221 17.7917 28.0415C18.1111 28.3609 18.2708 28.7359 18.2708 29.1665C18.2708 29.5971 18.1111 29.9721 17.7917 30.2915C17.4722 30.6109 17.0972 30.7707 16.6667 30.7707ZM25 30.7707C24.5694 30.7707 24.1944 30.6109 23.875 30.2915C23.5556 29.9721 23.3958 29.5971 23.3958 29.1665C23.3958 28.7359 23.5556 28.3609 23.875 28.0415C24.1944 27.7221 24.5694 27.5623 25 27.5623C25.4306 27.5623 25.8056 27.7221 26.125 28.0415C26.4444 28.3609 26.6042 28.7359 26.6042 29.1665C26.6042 29.5971 26.4444 29.9721 26.125 30.2915C25.8056 30.6109 25.4306 30.7707 25 30.7707ZM33.3333 30.7707C32.9028 30.7707 32.5278 30.6109 32.2083 30.2915C31.8889 29.9721 31.7292 29.5971 31.7292 29.1665C31.7292 28.7359 31.8889 28.3609 32.2083 28.0415C32.5278 27.7221 32.9028 27.5623 33.3333 27.5623C33.7639 27.5623 34.1389 27.7221 34.4583 28.0415C34.7778 28.3609 34.9375 28.7359 34.9375 29.1665C34.9375 29.5971 34.7778 29.9721 34.4583 30.2915C34.1389 30.6109 33.7639 30.7707 33.3333 30.7707Z" fill="#CDA274"/>
                    </svg>
                    SELHONO
                </div>
                <div className="mt-6 text-[#4D5053] font-serif leading-normal">
                    <p>It is a long established fact that a reader will be distracted lookings.</p>
                </div>
                <div className="flex mt-8">
                    
                <svg className= "mr-12" width="10" height="19" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="mr-12" width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="mr-12" width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg className="" width="17" height="18" viewBox="0 0 17 18" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             <div className=" w-2/3 ml-16 flex">
                <div className="justify-items-center items-center">
                  <h4 className="font-serif text-xl pb-2">Pages</h4>
                  <ul className="py-1 font-serif">
                    <li className="py-1 font-serif text-[#4D5053]">About Us</li>
                    <li className="py-1 font-serif text-[#4D5053]">Our Projects</li>
                    <li className="py-1 font-serif text-[#4D5053]">Our Teams</li>
                    <li className="py-1 font-serif text-[#4D5053]">Contact Us</li>
                    <li className="py-1 font-serif text-[#4D5053]">Services</li>
                  </ul>
                </div>
                <div className="px-16">
                   <div className="justify-items-center items-center">
                     <h4 className="font-serif text-xl pb-2">Services</h4>
                      <ul className="py-1 font-serif">
                    <li className="py-1 font-serif text-[#4D5053]">Kitchen</li>
                    <li className="py-1 font-serif text-[#4D5053]">Living Area</li>
                    <li className="py-1 font-serif text-[#4D5053]">Bathroom</li>
                    <li className="py-1 font-serif text-[#4D5053]">Dinning Area</li>
                    <li className="py-1 font-serif text-[#4D5053]">Bedroom</li>
                  </ul>
                   </div>
                </div>
                <div className="px-16">
                   <div className="justify-items-center items-center">
                     <h4 className="font-serif text-xl pb-2">Contact</h4>
                     <p className="font-serif text-[#4D5053]">55 East Birchwood Ave.</p>
                     <p className="pb-8 font-serif text-[#4D5053]"> Brooklyn, New York 11201</p>
                     <p className="font-serif text-[#4D5053]">contact@selhono.com</p>
                     <p className="font-serif text-[#4D5053]">(123) 456 - 7890</p>
                   </div>
                </div>
             </div>
             
            </div>
            <div className="font-serif text-[#4D5053] text-center mt-16">Copyright © SELHONO</div>
        </div >
    )
}
